...
{
    internal struct TopLevelAccelStruct
    {
    ...
    internal class HlbvhTopLevelBuilder
    {
        ...
        public void AllocateResultBuffers(uint instanceCount, ref TopLevelAccelStruct accelStruct)
        {
            ...
            accelStruct.topLevelBvh = new GraphicsBuffer(TopLevelAccelStruct.topLevelBvhTarget, (int)bvhNodeCount + 10, Marshal.SizeOf<BvhNode>()); // plus one for header
        }
