...
namespace UnityEngine.Rendering.UnifiedRayTracing
{
    internal class ComputeRayTracingShader : IRayTracingShader
    {
        ...
        internal ComputeRayTracingShader(string shaderFilename, string dispatchFuncName, Func<string, Type, Object> shaderFileLoader)
        {
            m_Shader = (ComputeShader) shaderFileLoader(shaderFilename+".compute", typeof(ComputeShader));
