...
namespace UnityEngine.Rendering.UnifiedRayTracing
{
    ...
    internal class GeometryPool : IDisposable
    {
        ...
        public int globalVertexBufferSrideBytes { get { return 5*sizeof(int); } }
        ...
        private void UpdateGeoGpuState(Mesh mesh, List<GeometryPoolSubmeshData> submeshData, GeometryPoolHandle handle)
        {
            ...
            if (!geoSlot.hasGPUData)
            {
                ...
                var uvAttrib = new VertexBufferAttribInfo();
                LoadVertexAttribInfo(mesh, VertexAttribute.TexCoord0, out uvAttrib);
                if (uvAttrib.buffer == null)
                    LoadVertexAttribInfo(mesh, VertexAttribute.TexCoord1, out uvAttrib);
                ...
                for (int submeshIndex = 0; submeshIndex < mesh.subMeshCount; ++submeshIndex)
                {
                    ...
                    AddVertexUpdateCommand(
                        ...
                        posAttrib, uvAttrib, normalAttrib,
        ...
        private void AddVertexUpdateCommand(
            ...
            in VertexBufferAttribInfo pos, in VertexBufferAttribInfo uv, in VertexBufferAttribInfo n,
            in BlockAllocator.Allocation location,
            GraphicsBuffer outputVertexBuffer)
        {
            ...
            if (uv.valid)
                attributes |= GeoPoolVertexAttribs.Uv;
            ...
            cmdBuffer.SetComputeIntParam(m_GeometryPoolKernelsCS, GeoPoolShaderIDs._InputUv0BufferStride, uv.stride);
            cmdBuffer.SetComputeIntParam(m_GeometryPoolKernelsCS, GeoPoolShaderIDs._InputUv0BufferOffset, uv.offset);
            ...
            cmdBuffer.SetComputeBufferParam(m_GeometryPoolKernelsCS, kernel, GeoPoolShaderIDs._Uv0Buffer, uv.valid ? uv.buffer : m_DummyBuffer);
